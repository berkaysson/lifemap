export const addFinancialDataUnitHelper = async (
  db,
  toBeUpdatedData,
  snackBarHandler
) => {
  try {
    ...
    snackBarHandler(
      "Financial Data unit could not added successfully 😕",
      "error"
    );
  }
};
...
export const updateFinancialDataUnitHelper = async (
  ...
  try {
    ...
    await db.financialData.put(financialDataUnit);
    snackBarHandler(
      "Financial Data unit edited successfully 😝",
      "success"
    );
  } catch (error) {
    console.error("Error updating Financial data:", error);
    snackBarHandler(
      "Financial Data unit could not edited successfully 😔",
      "error"
    );
  }
};

export const deleteFinancialDataUnitHelper = async (
  db,
  dateID,
  dataUnitID,
  snackBarHandler
  ...
  try {
    ...
    snackBarHandler(
      "Financial Data unit could not deleted successfully 😕",
      "error"
    );
  }
};
